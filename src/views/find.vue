        ...
        <div class="_full_inner _effect component-find" :class="{'_effect--30':decline}">
            <div class="_full component-find-content">
                <div class="weui_cells weui_cells_access">
                    <router-link class="weui_cell" href="javascript:;" to='{path:"albums-friends",append:true}'>
                ...
                <!-- flag -->
                <div class="weui_cells weui_cells_access">
                    <router-link class="weui_cell" href="javascript:;" to='{path:"sao-yi-sao",append:true}'>
                    ...
                    <router-link class="weui_cell" href="javascript:;" to='{path:"yao-yi-yao",append:true}'>
                ...
                <!-- flag -->
                <div class="weui_cells weui_cells_access">
                    <router-link class="weui_cell" href="javascript:;" to='{path:"drift-bottle",append:true}'>
                ...
                <!-- flag -->
                <div class="weui_cells weui_cells_access">
                    <div class="weui_cell" href="javascript:;" @click='hrefShopping()'>
